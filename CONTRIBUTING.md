# Contributing to lexisuite

Thank you for your interest in contributing to lexisuite! This document provides guidelines and instructions for contributing to this project.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/lexisuite.git
   cd lexisuite
   ```
3. **Add the upstream remote**:
   ```bash
   git remote add upstream https://github.com/igor-kan/lexisuite.git
   ```
...
By contributing to lexisuite, you agree that your contributions will be licensed under the project's [MIT License](LICENSE).
